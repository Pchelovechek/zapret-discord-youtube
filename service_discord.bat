...
--filter-tcp=443 --hostlist=\"%~dp0list-discord.txt\" --dpi-desync=fake,udplen --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls=\"%BIN%tls_clienthello_www_google_com.bin\"
